...
public class CommandTestUtil {
    ...
    public static void assertCommandFailure(
        ...
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredJobList());
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        Person person = model.getFilteredJobList().get(targetIndex.getZeroBased());
        final String[] splitName = person.getName().fullName.split("\\s+");
        model.updateFilteredJobList(new NameContainsKeywordsPredicate(Arrays.asList(splitName[0])));
